...
Original file is located at
    https://colab.research.google.com/drive/1BUU8PXsObzwzgsyXq94RX_isRcdbMiWy
"""
...
# Example usage
wav_file_path = '/content/sample-3s.wav'  # Replace with your WAV file path
...
# Example usage
wav_file_path = '/content/sample-9s.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)
...
# Example usage
wav_file_path = '/content/sample-12s.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)
...
# Matnni belgilash
text ="suniy intelek can become a close friend of humanity in the future or control humanity"
